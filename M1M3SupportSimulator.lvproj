...
AddOutputFilter chunkFilter
		...
		<Item Name="UDPCommunication" Type="Folder">
			...
			<Item Name="UDP Server Inclinometer.vi" Type="VI" URL="../TypeDefs/UDP Server Inclinometer.vi"/>
		</Item>
